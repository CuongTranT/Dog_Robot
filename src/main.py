...
def move_all_legs(pos_list):
    ...
    if ok:
        ...
        set_servo_angle(0, deg_hip + 10, 1, 0)
        set_servo_angle(1, deg_knee -5, 1,  5 )
    else:
    ...
    if ok:
        ...
        set_servo_angle(3, deg_knee, 1, 5)
    else:
    ...
    if ok:
        ...
        set_servo_angle(4, deg_hip, 1, 5)
        set_servo_angle(5, deg_knee, -1, +218)
    else:
    ...
    if ok:
        ...
        set_servo_angle(6, deg_hip, 1, 5)
        set_servo_angle(7, deg_knee, -1, +218)
    else:
